...
internal class YAxisDelegate(
    ...
    private val tensionAnimator = TensionAnimator { tension, minY, maxY ->
        ...
        series.forEach { series ->
            ...
            series.legends.forEach { legend ->
                legend.yDrawPixel = legend.position.ordinateToPx(viewSize.height, minY, maxY)
            }
        }
    ...
    private fun List<Float>.toLegends(
        ...
        val absolutePosition = it.pxToOrdinate(viewSize.height, absoluteMinY, absoluteMaxY)
        AnimatingYLegend(
            position = absolutePosition,
            label = axisFormatter.format(absolutePosition, zoom),
            yDrawPixel = absolutePosition.ordinateToPx(viewSize.height, localMinY, localMaxY)
        )
    }
